...
//    Mat frame;
    ...
    while (true)
    {
        auto frame=cv::imread("D:\\temp\\images\\i.jpg");
//        source >> frame;
        if (frame.empty())
            break;
        ...
        putText(frame, format("OpenCV DNN %s FPS = %.2f", "-", fpsOpencvDNN), Point(10, 50), FONT_HERSHEY_SIMPLEX, 1.3, Scalar(0, 0, 255), 4);
